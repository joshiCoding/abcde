...
<head>
    ...
    <link rel="stylesheet" href="<?php echo $abspath;?>/main.css" text ="text/css">
    <script src="<?php echo $abspath;?>/assets/js/main.js" defer></script>
...
<!-- hero section starts -->
    <section class="hero" id = "home">
       <div class="hero-background-img"><img src="<?php echo $abspath;?>/assets/img/hero_1-min.jpg" alt=""></div>
    ...
    <section class="programs" id = "programs">
        ...
        <div class="programs-content">
            ...
            <div class="programs-content-prog prog-box">
                <div class="prog-box-img"><img src="<?php echo $abspath;?>/assets/img/img_1-min.jpg" alt=""></div>
            ...
            <div class="programs-content-prog prog-box">
                <div class="prog-box-img"><img src="<?php echo $abspath;?>/assets/img/img_2-min.jpg" alt=""></div>
                <div class="prog-box-content">
        ...
        <div class="prog-box-container">
            ...
            <div class="programs-content-prog prog-box">
                <div class="prog-box-img"><img src="<?php echo $abspath;?>/assets/img/img_3-min.jpg" alt=""></div>
                <div class="prog-box-content">
             ...
             <div class="programs-content-prog prog-box">
                <div class="prog-box-img"><img src="<?php echo $abspath;?>/assets/img/img_4-min.jpg" alt=""></div>
                <div class="prog-box-content">
    ...
    <section class="courses" id="courses">
        ...
        <div class="courses-content">
            ...
            <div class="courses-content-illustration">  
                 <img src="<?php echo $abspath;?>/assets/img/teacher-illustration.svg" alt="">
                </div>
        </div>
    </section>
...
<section class="demo" id="demo">
        <div class="demo-background-img"><img src="<?php echo $abspath;?>/assets/img/hero_1-min.jpg" alt=""></div>
        <div class="demo-head">Request a free Demo Class</div>
        <div class="demo-content">
            <div class="demo-content-form">
                
                <form method = "post" action="/server/form-submission.php" class="demo-before-submit">
                ...
                <div class="demo-after-submit">
                    ...
                    <p class="demo-response">Thanks for putting enquiry for demo.<br> We will reach you the soonest we can.</p>
            ...
            <div class="demo-content-illustration">
                <img src="<?php echo $abspath;?>/assets/img/tutorial-illustration.svg" alt="">
            </div>
        </div>
    </section>
...
<!-- for common background of about and contact section -->
    <div class="about-contact-bg">
        <img src="<?php echo $abspath;?>/assets/img/about-contact-bg-min.jpeg" alt="" class= "bg-img">
    ...
    <section class="contact" id = "contact">
        ...
        <div class="contact-illustration">
            <img src="<?php echo $abspath;?>/assets/img/about-bg-img.svg" alt="">
        </div>
    </section>
...
<section class="feedback" id="feedback">
        ...
        class = "feedback-before-submit">
         ...
         <div class="feedback-after-submit">
            ...
            <p>Thanks for giving feedback <br>We will looking into your feedback very sincerely.</p>
